...
public String getFormNo() {
    return formno;  // Add a getter method for formno
}
    SignupOne()
{
    setLayout(null);
...
add(female);
ButtonGroup gendeGrp=new ButtonGroup();
gendeGrp.add(male);
gendeGrp.add(female);
...
add(other);
ButtonGroup gendeGrp1=new ButtonGroup();
gendeGrp1.add(married);
gendeGrp1.add(unmarried);
gendeGrp1.add(other);
...
try {
    ...
    public static void main(String[] args) {
        ...
        String formNo = signupOne.getFormNo(); // Assuming you have a method to get formNo in SignupOne
